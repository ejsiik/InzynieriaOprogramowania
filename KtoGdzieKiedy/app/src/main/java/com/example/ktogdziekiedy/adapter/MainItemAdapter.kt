...
class MainItemAdapter (private val collections: List<MainModel>): RecyclerView.Adapter<MainItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.binding.apply {
            ...
            val subItemAdapter = SubItemAdapter(collection.subItemModel)
